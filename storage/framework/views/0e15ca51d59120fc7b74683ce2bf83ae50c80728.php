        ...
        <div class="d-flex align-items-center">
            <div class="ml-3">
             ...
             <div class="d-flex justify-content-between">
                    ...
                    <a class="btn btn-success mx-2" href="<?php echo e(route('admin.kunjungans.create')); ?>" title="Create a kunjungan"> 
                    Add Visit        
                    <i class="fas fa-plus-circle"></i>
                  
                      </a>              
                    <a class="btn btn-primary" href="<?php echo e(route('register-admin')); ?>" title="Create a kunjungan">Add Admin <i class="fas fa-plus-circle"></i>
                    </a>
    ...
    <table class="table table-bordered table-responsive-lg">
        ...
        <?php $__currentLoopData = $kunjungans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kunjungan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td>
                    <form action="<?php echo e(route('admin.kunjungans.destroy', $kunjungan->id)); ?>" method="POST">

                        <a href="<?php echo e(route('admin.kunjungans.show', $kunjungan->id)); ?>" title="show">
                            <i class="fas fa-eye text-success  fa-lg"></i>
                        </a>

                        <a href="<?php echo e(route('admin.kunjungans.edit', $kunjungan->id)); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nadiatiara/visit-its/resources/views/Admin/kunjungans/index.blade.php ENDPATH**/ ?>