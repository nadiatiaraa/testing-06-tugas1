<?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>
    <form action="<?php echo e(route('admin.kunjungans.store')); ?>" method="POST" enctype="multipart/form-data" >
        <?php echo csrf_field(); ?>
            <!-- 'user_id'=>$i,
            'admin_id'=>$i,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nadiatiara/visit-its/resources/views/Admin/kunjungans/create.blade.php ENDPATH**/ ?>